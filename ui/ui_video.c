...
static void ApplyChanges( void *unused )
{
	...
	Cvar_SetValue( "r_mode", s_mode_list.curvalue + 3 ); // offset for eliminating < 640x480 modes
...
//	s_video_menu.x = viddef.width * 0.50;
	...
	s_mode_list.curvalue = max((Cvar_VariableValue("r_mode") - 3), 0); // offset for getting rid of < 640x480 resolutions
