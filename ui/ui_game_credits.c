...
void M_Credits_MenuDraw( void )
{
	...
	Menu_DrawString(scaledHud(25), scaledHud(25), "CITIZEN ABEL: ^9GRAVITY BONE", 255);

	Menu_DrawString(scaledHud(25), scaledHud(50), "CREATED BY", 255);
	Menu_DrawString(scaledHud(30), scaledHud(57), "^0Brendon Chung", 255);
	Menu_DrawString(scaledHud(130), scaledHud(57), "^0http://blended.planethalflife.gamespy.com", 255);
	

	Menu_DrawString(scaledHud(25), scaledHud(78), "SPECIAL THANKS TO", 255);
	Menu_DrawString(scaledHud(30), scaledHud(85), "^0David Hyde & Mad Dog", 255);
	Menu_DrawString(scaledHud(130), scaledHud(85), "^0http://lazarus.planetquake.gamespy.com", 255);

	Menu_DrawString(scaledHud(30), scaledHud(92), "^0Knightmare", 255);
	Menu_DrawString(scaledHud(130), scaledHud(92), "^0http://kmq2.quakedev.com", 255);

	Menu_DrawString(scaledHud(30), scaledHud(99), "^0id Software", 255);
	Menu_DrawString(scaledHud(130), scaledHud(99), "^0http://www.idsoftware.com", 255);



	Menu_DrawString(scaledHud(25), scaledHud(120), "MUSIC BY", 255);
	Menu_DrawString(scaledHud(30), scaledHud(127), "^0Xavier Cugat", 255);
