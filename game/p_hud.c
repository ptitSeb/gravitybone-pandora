...
void HelpComputer (edict_t *ent)
{
	...
	else
	{
		Com_sprintf (string, sizeof(string),
			...
			"xv 32 yv 8 picn2 \"maps/%s\" "			// background

			//"xv 202 yv 12 string2 \"%s\" "		// skill
			"xv -216 yv -120 cstring \"%s\" "		// level name

			"xv -204 yv -80 cstring ^0OBJECTIVES: "		// help 1

			"xv -208 yv -50 cstring \"%s\" "		// help 1
			"xv -208 yv 20 cstring \"%s\" ",		// help 2
...
void G_SetStats (edict_t *ent)
{
	...
	//ent->client->ps.stats[STAT_HINTTITLE] = 0;
