...
#ifdef KMQUAKE2_ENGINE_MOD
		e->s.modelindex5,e->s.modelindex6,e->s.modelindex7,e->s.modelindex8,
#endif
		e->s.frame,
...
void Cmd_Inven_f (edict_t *ent)
{
	...
	//new show-inventory command

	ent->client->ps.stats[STAT_WEAPBOX] = 120;
