...
BUILD_KMQUAKE2=NO               # kmquake executable (uses OSS for cdrom and sound)
BUILD_KMQUAKE2_DEDICATED=NO	# build a dedicated kmquake2 server
...
CC?=gcc
BASE_CFLAGS=-mcpu=cortex-a8 -mfpu=neon -mfloat-abi=softfp -fdiagnostics-color=auto -fsigned-char -DPANDORA -g
...
#LOCALBASE?=/usr
LOCALBASE?=/mnt/utmp/codeblocks/usr
X11BASE?=/mnt/utmp/codeblocks/user/usr
PREFIX?=/mnt/utmp/gravity-bones
...
ifeq ($(strip $(BUILD_GAME)),YES)
  TARGETS+=$(BINDIR)/kmq2game$(ARCH).$(SHLIBEXT)
endif
...
QUAKE2_OBJS = \
	...
	$(BUILDDIR)/client/ui_options_ingame.o \
...
$(BUILDDIR)/client/ui_options_ingame.o :	$(UI_DIR)/ui_options_ingame.c
	$(DO_CC)
...
$(BINDIR)/kmq2game$(ARCH).$(SHLIBEXT) : $(GAME_OBJS)
...
$(BUILDDIR)/game/g_splinetrain.o :     	$(GAME_DIR)/g_splinetrain.c
	$(DO_SHLIB_CC)
